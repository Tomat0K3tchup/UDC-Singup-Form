...
export class FormCountrySelect extends FormInput {
  ...
  firstUpdated() {
    super.firstUpdated();
    const tom = new TomSelect(this.$input, {
      sortField: {
        field: "text",
        direction: "asc",
      },
      ...
      maxOptions: null,
      onInitialize: this._generateLanguageLookupTom,
    });
  ...
  _generateLanguageLookupTom() {
    ...
    try {
      const lang = langCountryCode.split("-")[1];
      this.addItem(lang, false);
    } catch (error) {
      //FIXME: could also be an error
      this.addItem(langCountryCode, false);
    }
  }
      ...
      <div class="formInput">
        <div class="container">
          ...
          <select
            ...
            class="countrySelect ${this._hasError ? "invalid" : ""}"
            id="${this.id}"
          ...
          >
            ...
            <optgroup id="country-optgroup-Suggestion" label="Suggestions"></optgroup>
...
customElements.define("form-country-select", FormCountrySelect);
